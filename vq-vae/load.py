...
bin_file = '/nas/home/thawani/etok/factorizer/vq-vae/ar_256_42_glowing-water-69.bin'
train_file = '/nas/ckgfs/users/thawani/etok/ar_factorizer_data/train.tsv' # '/nas/ckgfs/users/thawani/etok/count_1w_train.txt' # '/nas/ckgfs/users/thawani/etok/num_factorizer_data/numtrain.txt' #
...
def batch_decode(codes):
    ids, ppls = model.decode(torch.tensor(codes).to('cuda:0'))
